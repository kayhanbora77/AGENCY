...
FROM dbo.TA10_STANDARD_BLUESTAR01 t
JOIN (
    VALUES
    {values_block}
...
def main():
    csv_file = "/home/kayhan/Desktop/Gelen_Datalar/BLUESTAR/FILTER-3(API)/DELAY/BLUESTAR_Delayed_Checked.csv"
    output_file = "/home/kayhan/Desktop/Gelen_Datalar/BLUESTAR/FILTER-3(API)/DELAY/delay_update_script.txt"
