...
TABLE_NAME = "TA_STANDARD_YATRA"

CSV_FILE_PATH = "/home/kayhan/Desktop/Gelen_Datalar/YATRA/FILTER-1(CLEANED)/YATRA_TARGET_202603131250.csv"
...
class CSVToDBImporter:
    ...
    def _parse_row(self, row, flight_cols):
        ...
        eticket = str(
            getattr(row, "TicketNumber", None)
            or getattr(row, "ETicketNo", None)
            or getattr(row, "TicketNo", None)
            or ""
        )
        pax_name = str(
